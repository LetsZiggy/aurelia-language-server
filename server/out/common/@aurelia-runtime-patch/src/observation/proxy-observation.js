...
const objectHandler = {
    get(target, key, receiver) {
        ...
        const connectable = (0, connectable_switcher_1.currentConnectable)();
        if (!connectable_switcher_1.connecting || doNotCollect(key) || connectable == null) {
...
const arrayHandler = {
    ...
    ownKeys(target) {
        var _a;
        (_a = (0, connectable_switcher_1.currentConnectable)()) === null || _a === void 0 ? void 0 : _a.observe(target, 'length');
...
function wrappedArrayMap(cb, thisArg) {
    ...
    (_a = (0, connectable_switcher_1.currentConnectable)()) === null || _a === void 0 ? void 0 : _a.observeCollection(raw);
    return wrap(res);
}
...
function wrappedArrayFlatMap(cb, thisArg) {
    ...
    return getProxy(
    // @ts-ignore
    raw.flatMap((v, i) => wrap(cb.call(thisArg, wrap(v), i, this))));
}
