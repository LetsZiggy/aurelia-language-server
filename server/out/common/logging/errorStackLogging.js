...
exports.generateDependencyTreeSingle = exports.generateDependencyTree = void 0;
...
let globalIndex = 0;
function generateDependencyTree(input) {
    const tracker = {};
    let trackerIndex = 0;
...
exports.generateDependencyTree = generateDependencyTree;
/**
 * "Single" - One input at a time (cf. generateDependencyTree, where we input string[][])
 */
function generateDependencyTreeSingle(tracker, input) {
    let trackerIndex = 0;
    globalIndex++;
...
exports.generateDependencyTreeSingle = generateDependencyTreeSingle;
 ...
 * { a: { b: { 1: 'leaf' }, c: { 2: 'leaf' } } }
 */
function generateRecursive(tracker, index, rawList) {
...
//# sourceMappingURL=errorStackLogging.js.map