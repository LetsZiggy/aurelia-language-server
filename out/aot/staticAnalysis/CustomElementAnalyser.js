...
exports.CustomElementAnalyser = void 0;
...
const ValueConverterAnalyser_1 = require("./ValueConverterAnalyser");
class CustomElementAnalyser {
    static getAureliaComponentInfoFromClassDeclaration(sourceFile, checker) {
        let result;
        ...
        sourceFile.forEachChild((node) => {
            ...
            if (!isClassDeclaration)
                return;
            const fulfillsAureliaConventions = ConventionService_1.ConventionService.fulfillsAureliaConventions(node);
            ...
            if (validForAurelia) {
                ...
                // Value Converter
                const isValueConverterModel = ValueConverterAnalyser_1.ValueConverterAnalyser.checkValueConverter(targetClassDeclaration);
                if (isValueConverterModel) {
                    result = ValueConverterAnalyser_1.ValueConverterAnalyser.getComponentInfo(targetClassDeclaration, sourceFile, documentation);
                    return;
                }
                // Standard Component
                ...
                if (fs.existsSync(conventionViewFilePath)) {
                    ...
                    viewFilePath =
                        (_a = getTemplateImportPathFromCustomElementDecorator(targetClassDeclaration, sourceFile)) !== null && _a !== void 0 ? _a : '';
                }
    ...
    static getClassDecoratorInfos(classDeclaration) {
        var _a;
...
exports.CustomElementAnalyser = CustomElementAnalyser;
...
//# sourceMappingURL=CustomElementAnalyser.js.map